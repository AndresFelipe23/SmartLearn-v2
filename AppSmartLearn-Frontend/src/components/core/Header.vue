<template>
  <v-app-bar app elevate-on-scroll elevation="8" relative>
    ...
    <v-toolbar-title class="font-weight-bold letra text-h5 mx-2">SMARTLEARN</v-toolbar-title>
    ...
    <v-menu offset-y>
      ...
      <v-list dense>
        <v-list-item-group v-model="selectedItem" color="primary">
          <v-list-item v-for="(item, i) in items" :key="i" @click="item.text === 'Salir' ? salir() : null">
            <v-list-item-icon>
