              ...
              <template>
                <v-card-text class="mt-12">
                  ...
                  <v-row align="center" justify="center">
                    <v-col cols="12" sm="8">
                      <v-row>
                        <v-text-field rounded dense background-color="#f6f2f2" v-model="name" label="Nombre" outlined
                      ...
                      <v-row v-for="i in courses" :key="i._id">
                        <v-select rounded style="border-radius: 18px;" background-color="#f6f2f2" v-model="grades"
                          :items="i.grade" chips label="Grados" dense solo multiple></v-select>
                      </v-row>
                      <center>
                        <br>
                                    ...
                                    <v-container fluid>
                                      <v-row v-for="i in courses" :key="i._id">
                                        <v-col cols="12" sm="4" md="4">
                                          <v-checkbox v-model="grades" :label="a" color="red" v-for="a in i.grade"
                                            :key="a" :value="a" hide-details></v-checkbox>
                                        </v-col>
                                      </v-row>
                                    </v-container>
                                  </v-card-text>
                      ...
                      <br> <br> <br>
                      <div>
                        <v-snackbar v-model="hasSaved" :timeout="2000" absolute bottom left color="red">
                          {{ msg }}
                        </v-snackbar>
                      </div>
                    </v-col>
