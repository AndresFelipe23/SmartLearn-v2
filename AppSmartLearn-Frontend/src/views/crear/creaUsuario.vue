    ...
    <div id="personal" style="width: 90%; margin-left:50px" class="fondosub">
      ...
      <div class="row justify-content-md-center">
        ...
        <v-row>
          ...
          <v-col col="4" xs="4">
            <div v-if="menu == '6525b7b49b07590f3ba23626'">
              <img src="../../assets/docen.svg" style="max-width:400px; margin-top:100px">
            </div>
            <div v-if="menu == '6525b7bc9b07590f3ba23629'">
              <img src="../../assets/estudiante.svg" style="max-width:300px; margin-top:100px">
            </div>
            <div v-if="menu == '6525b707b28d97160f2d7830'">
            ...
            <div>
              ...
              <template>
                <v-stepper v-model="e1" style="margin:10px;
                              " :class="{ 'boxStudent': this.menu === '6525b7bc9b07590f3ba23629' }">
                  ...
                  <v-stepper-header style="background-color:rgba(255, 192, 203, 0.26)"
                    v-if="menu != '6525b7bc9b07590f3ba23629'">
                  ...
                  <v-stepper-items class="fondocard">
                    <v-stepper-content step="1">
                      <v-card class="mb-12 fondocaja" height="220px">
                        <v-row>
                          <v-col cols="12" sm="6">
                      ...
                      <v-btn
                        v-if="name != '' && apellido != '' && selected != '' && menu != '6525b707b28d97160f2d7830' && usuario != '' && contrasena1 != ''"
                      ...
                      <template v-if="menu == '6525b707b28d97160f2d7830'">
                    ...
                    <v-stepper-content step="2" v-if="menu == '6525b7b49b07590f3ba23626'">
                      ...
                      <v-btn style=" margin-right:10px" color="rgba(0, 0, 255, 0.356)" @click="e1 = 1"
                        v-if="menu != '6525b707b28d97160f2d7830'">
                        Regresar
                      </v-btn>
                      <v-btn style=" margin-right:10px" color="rgba(0, 0, 255, 0.356)" @click="e1 = 1"
                        v-if="menu == '6525b707b28d97160f2d7830'">
                    ...
                    <v-stepper-content step="3" v-if="menu == '6525b7bc9b07590f3ba23629'">
                      <v-card class="mb-12 fondocaja" height="200px">
                        <v-row>
                          <v-col cols="12" sm="6">
                    ...
                    <!--Estudiante datos acudiente-->
                    <v-stepper-content step="2" v-if="menu == '6525b7bc9b07590f3ba23629'">
                      <v-card class="mb-12 fondocaja" height="220px">
                        <v-row>
                          <v-col cols="12" sm="6">
                            <v-text-field style="margin:10px" v-model="nameAcudiente" background-color="#D4D4D4"
                              onkeyup="javascript:this.value=this.value.toUpperCase();" label="Nombre del acudiente"
                              outlined dense color="blue" autocomplete="false" class="mt-4" />
                          </v-col>

                          <v-col cols="12" sm="6">
                            <v-text-field style="margin:10px" v-model="apellidoAcudiente" background-color="#D4D4D4"
                              onkeyup="javascript:this.value=this.value.toUpperCase();" label="Apellido del acudiente"
                              outlined dense color="blue" autocomplete="false" class="mt-4" />
                          </v-col>
                        </v-row>
                        <v-row style="margin-top:-60px">
                          <v-col cols="12" sm="6">
                            <v-text-field style="margin:10px" v-model="Direccion" background-color="#D4D4D4"
                              label="Dirección" outlined dense color="blue" autocomplete="false" class="mt-4" />
                          </v-col>
                          <v-col cols="12" sm="6">
                            <v-text-field style="margin:10px;" v-model="CelularAcudiente" background-color="#D4D4D4"
                              type="number" label="Celular" outlined dense color="blue" autocomplete="false" />
                          </v-col>
                        </v-row>
                        <v-row style="margin-top:-60px">
                          <v-col cols="12" sm="6">
                            <vs-input v-model="emailAcudiente"
                              style=" font-weight: bold;background-color:#D4D4D4;margin:10px;margin-top:30px; color:#636060;border:solid 1px;border-radius:5px"
                              border label-placeholder="Usuario O Email">

                              <template v-if="validEmailAcudiente" #message-success>
                                Email Valid
                              </template>
                              <template v-if="!validEmailAcudiente && emailAcudiente !== ''" #message-danger>
                                Email Invalid
                              </template>
                            </vs-input>
                          </v-col>
                      ...
                      <v-btn
                        v-if="nameAcudiente != '' && apellidoAcudiente != '' && Direccion != '' && menu != '6525b707b28d97160f2d7830' && emailAcudiente != ''"
                        color="green" @click="pasaPantalla3()">
                        Continue
                      </v-btn>
                      <v-btn disabled
                        v-if="nameAcudiente == '' || apellidoAcudiente == '' || Direccion == '' || emailAcudiente == ''">
                        Continue
                      </v-btn>
...
export default {
    ...
    return {
      ...
      menuDocente: [
        ...
        },
        {
          ...
          {
            title: 'Listar',
            href: '/dashboard/welcome/listarnotices'
          },
          {
            title: 'Editar',
  ...
  computed: {
    ...
    validEmailAcudiente() {
      ...
      return /^\w+([-]?\w+)*@\w+([-]?\w+)*(\.\w{2,3})+$/.test(this.emailAcudiente)
    },
  ...
  methods: {
    ...
    created() {
      ...
      if (this.pantalla == 1) {
        this.menu = "6525b7b49b07590f3ba23626"
        this.heading = "REGISTRO DE DOCENTE"

      }
      if (this.pantalla == 2) {
        this.menu = "6525b7bc9b07590f3ba23629"
        this.heading = "REGISTRO DE ESTUDIANTE"
      }
      if (this.pantalla == 3) {
        this.menu = "6525b707b28d97160f2d7830"
    ...
    pasaPantalla2() {
      if (this.usuario != null && this.usuario != "") {
        if (this.validEmail == true) {
          ...
          this.msg = "Introduzca Una Direccion De Correo Valida"
          this.hasSaved = true
        }
      } else {
    ...
    pasaPantalla3() {
      if (this.nameAcudiente != null && this.nameAcudiente != "") {
        if (this.validEmailAcudiente == true) {
          if (this.CelularAcudiente != null && this.CelularAcudiente != "") {
            this.e1 = 3
          } else {
            this.msg = "El campo N° Identificación es necesario."
            this.hasSaved = true
    ...
    crearDocente() {
      if (this.menu == '6525b7bc9b07590f3ba23629') {
        this.pru = this.menuEstudiante;
      }
      if (this.menu == '6525b7b49b07590f3ba23626') {
        this.pru = this.menuDocente;
      }
      if (this.menu == '6525b707b28d97160f2d7830') {
      ...
      let json = {
        ...
        "CelularAcudiente": this.CelularAcudiente,
      ...
      console.log('courestu', json.courestu);
